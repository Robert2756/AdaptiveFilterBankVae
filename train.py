...
# initialize model
filterbank = Filterbank(N_filt=80, filt_dim=251, fs=16000, filterbank_adaptive=True).to(device)
...
# train loop
N_epochs = 600 # 18*600 = 9000 steps
...
torch.save({
    ...
    'loss': loss_sum,
}, os.path.join(save_dir, f"checkpoint_static_epoch_{epoch+1}.pth"))
